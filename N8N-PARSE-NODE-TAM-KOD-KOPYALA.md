# Parse DonanımArsivi Data Node - Kopyala Yapıştır

## 📋 Parse Node'unun Tam Kodu

Parse DonanımArsivi Data node'una şu kodu **TAMAMEN** yapıştır (eski kodu sil):
...
- ✅ Frontend'de link görünmeyecek, sadece metin olacak
